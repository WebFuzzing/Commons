...
export const RestReports: React.FC<RESTReport> = ({coveredHttpStatus, endpointIds}) => {
    const total = endpointIds.length;
    const allStatusCounts = calculateAllStatusCounts(coveredHttpStatus, endpointIds);
    ...
    return (
        <Card className="border-2 border-black p-6 rounded-none">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                <ReportTooltip tooltipText={getText(info.httpEndpointCodes, {
                    numberOfEndpoints: allStatusCounts["2XX"],
                    code: "2XX",
                ...
                <ReportTooltip tooltipText={getText(info.httpEndpointCodes, {
                    numberOfEndpoints: allStatusCounts["3XX"],
                    code: "3XX",
                    totalEndpoints: total
                })}>
                ...
                <ReportTooltip tooltipText={getText(info.httpEndpointCodes, {
                    numberOfEndpoints: allStatusCounts["4XX"],
                    code: "4XX",
                    totalEndpoints: total
                })}>
                ...
                <ReportTooltip tooltipText={getText(info.httpEndpointCodes, {
                    numberOfEndpoints: allStatusCounts["5XX"],
                    code: "5XX",
                    totalEndpoints: total
                })}>
            ...
            <div className="mt-6">
                ...
                <div className="flex justify-between font-bold">
                    <ReportTooltip tooltipText={info.numberOfEndpoints}>
                        <span># Endpoints:</span>
                    </ReportTooltip>
                    <span data-testid="rest-report-endpoint">{endpointIds.length}</span>
                </div>
                <div className="border-t border-black my-2"></div>
            </div>
        </Card>
